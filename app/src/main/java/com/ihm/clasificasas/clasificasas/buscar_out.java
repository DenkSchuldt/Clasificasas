 ...
 */
public class buscar_out extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buscar_out);
        ActionBar actionBar = getActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);

        spinner_ciudad = (Spinner)findViewById(R.id.buscar_out_ciudad);
        ...
        spinner_tipo = (Spinner)findViewById(R.id.buscar_out_tipo_casa);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(buscar_out.this, main.class);
